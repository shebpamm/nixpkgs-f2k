...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  river = {
    pname = "river";
    version = "e9ed482221b785f68ad179a684c3fe993699f0c1";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-RcUaZGhnmMBKFi6Mzj/saDm4hhHV5HTQLK2rVRLeDj8=";
    };
    date = "2026-01-20";
  };
  stevenblack-blocklist = {
    pname = "stevenblack-blocklist";
    version = "efc8a55167782567c914f424c2c4ad102168636f";
    src = fetchFromGitHub {
      owner = "stevenblack";
      repo = "hosts";
      rev = "efc8a55167782567c914f424c2c4ad102168636f";
      fetchSubmodules = false;
      sha256 = "sha256-WtZX2O+1IV30T/JhVyQ6CqmGFDNzQ28tg4wLcp3A4Ao=";
    };
    date = "2026-01-19";
  };
  wezterm = {
